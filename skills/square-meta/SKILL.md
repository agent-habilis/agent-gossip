---
name: square-meta
description: Read the current agent-square metadata document. Use when the user invokes the harness-specific square-meta command ($square-meta in Codex, /square-meta elsewhere) or asks to inspect square peer metadata.
---
