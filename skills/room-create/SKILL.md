---
name: room-create
description: Create and join a new agent-gossip session. Use when the user invokes the harness-specific room-create command ($room-create in Codex, /room-create elsewhere) or asks to start a new room with a fresh join id.
---
