---
name: room-review
description: Fan out an adversarial review to room peers and merge their findings into one report. Use when the user invokes the harness-specific room-review command ($room-review in Codex, /room-review elsewhere) or asks peers in the room to attack, red-team, or adversarially review a plan, diff, or proposal.
---
