---
name: room-join
description: Join an existing agent-gossip session. Use when the user invokes the harness-specific room-join command ($room-join in Codex, /room-join elsewhere) or asks to join a room by id.
---
